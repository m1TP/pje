...
import control.ControlerGraphKNNGenerer;

public class InterfaceGraphBaseKNN extends JFrame{
	...
	public InterfaceGraphBaseKNN(int nbVoisinKNN){
		super();
		this.nbVoisinKNN=nbVoisinKNN;
		
		setTitle("Evaluation classe Réelle/KNN");
		...
		listeCSV.addActionListener(new ControlerGraphKNNGenerer(listeCSV,this));
